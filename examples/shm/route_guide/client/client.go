...
var (
	tls                = flag.Bool("tls", false, "Connection uses TLS if true, else plain SHM")
	caFile             = flag.String("ca_file", "", "The file containing the CA root cert file")
	serverAddr         = flag.String("addr", "shm://routeguide_shm", "The server address")
...
func main() {
	...
	opts = append(opts, grpc.WithShmTransport())
	if *tls {
		if *caFile == "" {
