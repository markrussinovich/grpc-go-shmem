...
func (f *ServerTransportFactory) Accept() (ServerTransport, error) {
...
func (f *ClientTransportFactory) NewTransport(ctx context.Context, addr string) (ClientTransport, error) {
