...
// (google.golang.org/grpc/experimental/transport/client.ClientStream).
//
...
// ProtoWriteStream in experimental/transport/client and
// experimental/transport/server) and transparently
...
// engine forwards it to recover marshal-into-ring.
...
// interface (google.golang.org/grpc/experimental/transport/server.ServerStream).
//
...
// ProtoWriteStream capability keep INLINE_TX; a plugin whose stream implements
// only the mandatory byte interface falls back to Write.
var (
