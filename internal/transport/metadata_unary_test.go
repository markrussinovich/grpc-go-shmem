...
func TestUnary_MetadataAndStatus(t *testing.T) {
	...
	go func() {
		...
		if err := writeFrame(srvTx, FrameHeader{StreamID: fh.StreamID, Type: FrameTypeHEADERS, Flags: HeadersFlagINITIAL}, encodeHeaders(respH), context.Background()); err != nil {
